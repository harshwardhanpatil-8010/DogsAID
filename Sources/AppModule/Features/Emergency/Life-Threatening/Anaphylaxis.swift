...
struct AnaphylaxisView: View {
    ...
    private let steps: [InfoStep] = [
        InfoStep(
            ...
            audio: "Look for sudden swelling on the face, hives, or collapse. " +
            "Check if the dog is struggling to breathe.",
        ...
        InfoStep(
            title: "CALL VET NOW",
            instruction: "Transport the dog to the vet immediately for life-saving medication. " +
