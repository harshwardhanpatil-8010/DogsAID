...
struct BleedingControlView: View {
    ...
    private let steps: [InfoStep] = [
        InfoStep(
            ...
            instruction: "Use a clean cloth or bandage to apply firm, direct pressure to the wound for 5 minutes. " +
        ...
        InfoStep(
            ...
            instruction: "Wrap a bandage over the pressure cloth. " +
            "Ensure it is snug but not tight enough to cut off circulation.",
        ...
        InfoStep(
            ...
            instruction: "Look for pale gums, rapid breathing, or weakness. " +
            "These are signs of life-threatening blood loss.",
        ...
        InfoStep(
            ...
            instruction: "Transport the dog to the vet immediately. " +
            "Do not wait for the bleeding to stop completely if it is severe.",
