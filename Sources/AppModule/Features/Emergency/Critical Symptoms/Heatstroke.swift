...
struct HeatstrokeView: View {
    ...
    private let steps: [InfoStep] = [
        ...
        InfoStep(
            title: "COOL GENTLY",
            instruction: "Soak the coat with lukewarm water. " +
            "DO NOT use ice or freezing water as it causes dangerous shock.",
        ...
        InfoStep(
            ...
            instruction: "Aim to cool the dog until their temperature reaches 103°F. " +
            "Stop active cooling once this target is reached.",
        ...
        InfoStep(
            ...
            instruction: "Even if the dog seems better, internal organ damage is likely. " +
            "Professional vet care is mandatory.",
